    ...
    return (
        <div className="hero-section">
            <div className="img-div">
                <Image src={main} alt="hammad" height={581} width={437} className="img" />
            </div>
            <div className="text-div">
                <h1 className="its-hammad">Hi, Its <span>Hammad</span></h1>
                <h1 className="p-2">Im a <span>Developer</span></h1>
